        ...
        <b-row>
            <b-col cols="4">
                <b-card title="Basic Notifications">
                    <b-button variant="default" @click="basicNotification('Default notification','Here is the message body of the notification (optional)', 'simple')">Basic</b-button>
                ...
                <b-card title="HTML Notifications">
                    ...
                    <pre>
&lt;h4&gt;Dear {{ $store.state.user.userInfo.name.first_name }},&lt;/h4&gt;<br>
